...
return [
    ...
    */
    ...
    'default_datetime_format' => 'HH:mm:ss DD/MM/YYYY',
    ...
    'home_link' => config('backpack.base.route_prefix'),

    // Menu logo. You can replace this with an <img> tag if you have a logo.
    'project_logo' => '<img src="'.'/logo.png'.'" style="width: 32px; height: 32px;" alt="'.env('APP_NAME').'">',
